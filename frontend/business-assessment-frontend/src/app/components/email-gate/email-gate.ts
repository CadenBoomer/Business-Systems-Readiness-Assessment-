...
// response
// The URL https://api.assessment.thewebsitemembership.com/api/submit-assessment is your backend endpoint
...
// Old email gate: 
// this.http.post<any>('https://api.assessment.thewebsitemembership.com/api/submit-assessment', payload)
//     .subscribe({
//       next: (response) => {
//         this.router.navigate(['/results'], {
