...
const { sendMail, sendNotification } = require('../services/email');
    ...
    try {
        ...
        generatePDF(first_name, last_name, pathway, reasoning, confidence_score, summaryFull, priority_actions, anti_priority_warnings, graduation_outlook, narrativeReport)
            .then(pdfBuffer => {
                ...
                sendNotification(process.env.NOTIFICATION_EMAIL, first_name, last_name, email, pathway, pdfBuffer);
            });
